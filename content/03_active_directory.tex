...
The policy creates a folder C:\SOC. The folder policy is set on computer level. When to computer runs the policy, the folder gets created and the file from SYSVOL will be copied into this folder.
...
https://www.gfi.com/support/products/how-to-force-proxy-settings-via-group-policy
